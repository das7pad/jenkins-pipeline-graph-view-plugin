  ...
  describe("nestedGraphLayout", () => {
    describe("complexParallelSmokes.jenkinsfile", () => {
      ...
      it("should render layout", () => {
        shouldMatchSnapshot(stages, false);
      });
      it("should render collapsed layout", () => {
        shouldMatchSnapshot(stages, true);
      });
    });

    describe("gh1155_complexSmokes.jenkinsfile", () => {
      const stages = JSON.parse(
        '[{"name":"Non-Parallel Stage","state":"success","id":"6","type":"STAGE","children":[]},{"name":"Parallel Stage","state":"success","id":"11","type":"STAGE","children":[{"name":"Branch A","state":"success","id":"16","type":"PARALLEL","children":[]},{"name":"Skipped Branch B","state":"skipped","id":"17","type":"PARALLEL","children":[]},{"name":"Branch C","state":"success","id":"18","type":"PARALLEL","children":[{"name":"Nested 1 C","state":"success","id":"31","type":"STAGE","children":[]},{"name":"Nested 2 C","state":"success","id":"49","type":"STAGE","children":[]},{"name":"Skipped stage c nested 3","state":"skipped","id":"60","type":"STAGE","children":[]},{"name":"Skipped stage c nested 4","state":"skipped","id":"65","type":"STAGE","children":[]}]},{"name":"Branch D","state":"success","id":"19","type":"PARALLEL","children":[{"name":"Skipped stage d nested 1","state":"skipped","id":"33","type":"STAGE","children":[]},{"name":"Nested 2 D","state":"success","id":"46","type":"STAGE","children":[]}]}]},{"name":"Skipped stage 1","state":"skipped","id":"76","type":"STAGE","children":[]},{"name":"Skipped stage 2","state":"skipped","id":"91","type":"STAGE","children":[]},{"name":"Parallel Stage 2","state":"success","id":"106","type":"STAGE","children":[{"name":"Branch A","state":"skipped","id":"110","type":"PARALLEL","children":[]},{"name":"Branch B","state":"success","id":"111","type":"PARALLEL","children":[]},{"name":"Branch C","state":"success","id":"112","type":"PARALLEL","children":[{"name":"Nested 1","state":"success","id":"122","type":"STAGE","children":[]},{"name":"Nested 2","state":"success","id":"133","type":"STAGE","children":[]}]}]}]',
      ) as StageInfo[];
 ...
 */
function trimStageOnLabel(label: NodeLabelInfo) {
  if (label.stage) {
    label.stage = {
      ...label.stage,
      children: [],
...
function shouldMatchSnapshot(stages: StageInfo[], collapsed: boolean) {
